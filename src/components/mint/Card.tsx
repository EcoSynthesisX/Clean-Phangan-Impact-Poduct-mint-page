...
const Card: React.FC<CardProps> = ({ type, className }) => {
  ...
  const textColorClass = textColorClasses[color] || 'text-white' // Default to text-white if the color is not found
  const borderColorClass = borderColorClasses[color] || 'border-white' // Default to border-white if the color is not found
